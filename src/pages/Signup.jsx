...
const Signup = () => {
    ...
    const sendOTP = async () => {
        ...
        try {
            const response = await axios.post("https://ecom-production-8da0.up.railway.app/send-otp", { email: formData.email });
    ...
    const verifyOTP = async () => {
        ...
        try {
             const response = await axios.post("https://ecom-production-8da0.up.railway.app/verify-otp", { email: formData.email, otp });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://ecom-production-8da0.up.railway.app/api/auth/signup", {
